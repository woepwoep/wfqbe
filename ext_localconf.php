...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTypoScript('wfqbe', 'editorcfg', '
    tt_content.CSS_editor.ch.tx_wfqbe_pi1 = < plugin.tx_wfqbe_pi1.CSS_editor
', 43);


\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPItoST43('wfqbe', 'pi1/class.tx_wfqbe_pi1.php', '_pi1', 'list_type', 0);
